...
if __name__ == '__main__':
    ...
    video_depth_anything.load_state_dict(torch.load(f'/path/to/model/models--depth-anything--Video-Depth-Anything-Large/{checkpoint_name}_{args.encoder}.pth', map_location='cpu'), strict=True)
